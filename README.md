...
python -m pytest tests -q                           # 661 tests, all offline; browser tests use the Chrome you already have
...
- Tested: 661 offline tests and, on the real Azure agent, 38 evaluation cases (`docs/evidence/eval_report.md`) and the 8-step demo (`scripts/eval/demo_check.py`).
