...
- Prefer small, reviewable diffs. Explain what you changed and why in plain language. Keep the tests green (69, all offline).
...
tests/                         69 tests, all offline (engine, tools, agent loop with a fake client, API, timeouts/retries/logging/API hardening)
